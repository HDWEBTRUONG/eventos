...
public class Constants {
    ...
    private Constants(){}
    //ホームのURL
    public static final String Event = "inoguchi";
    //ベースURL
    ...
    public static final String EXHIBITER_DOMAIN_4 = "XXXXXXXXXXXX";
    public static final String EXHIBITER_DOMAIN_5 = "XXXXXXXXXXXX";
    // GoogleMapのURL
    ...
    public static final String GCM_SENDER_ID = "501268283986";
}
