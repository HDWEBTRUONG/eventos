...
public class Constants {
    ...
    private Constants(){}
    //ホームのURL
    public static final String Event = "edogawa-u";
    //ベースURL
    ...
    //アプリ内に表示させるドメイン
    public static final String EXHIBITER_DOMAIN_1 = "edogawa-u.ac.jp";
    ...
    public static final String GCM_SENDER_ID = "533456946016";
}
